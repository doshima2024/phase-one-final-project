For this project, I've built a single page application using an index.html file, index.jss file for JavaScript, style.css file for CSS styling and a db.json file that is custom created.
